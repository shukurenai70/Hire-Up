...
import { MoreHorizontal, PlusCircle, FileText, Video, X } from "lucide-react";
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onSelect={() => handleViewDetails(resource)}>View Details</DropdownMenuItem>
                        <DropdownMenuItem onSelect={() => handleDeleteClick(resource)}>Delete</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
                </TableRow>
